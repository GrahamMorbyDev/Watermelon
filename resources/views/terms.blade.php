    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p>The information contained in this website is for general information purposes only. The information is
                provided by {{ config('app.name', 'Placeholder') }} and while we endeavour to keep the information up to date and correct,
            ...
            <p>Through this website you are able to link to other websites which are not under the control of
                {{ config('app.name', 'Placeholder') }}. We have no control over the nature, content and availability of those sites.
                The inclusion of any links does not necessarily imply a recommendation or endorse the views
                expressed within them.</p>
            <p>Every effort is made to keep the website up and running smoothly. However, {{ config('app.name', 'Placeholder') }} takes no
